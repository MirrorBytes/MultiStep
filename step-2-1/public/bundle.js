...
function create_fragment(ctx) {
	...
	let form_levels = [/*$$restProps*/ ctx[1], { class: "form" }];
	let form_data = {};
	...
	const block = {
		c: function create() {
			...
			attr_dev(input, "class", "submit svelte-1j30d39");
			attr_dev(input, "placeholder", "Submit");
			add_location(input, file, 27, 2, 535);
			set_attributes(form, form_data);
			toggle_class(form, "svelte-1j30d39", true);
			add_location(form, file, 24, 0, 476);
		},
		...
		p: function update(ctx, [dirty]) {
			...
			set_attributes(form, form_data = get_spread_update(form_levels, [dirty & /*$$restProps*/ 2 && /*$$restProps*/ ctx[1], { class: "form" }]));
			toggle_class(form, "svelte-1j30d39", true);
		},
...
function create_fragment$1(ctx) {
	...
	const block = {
		c: function create() {
			...
			t1 = space();
			input = element("input");
			add_location(div, file$1, 32, 2, 528);
			set_attributes(input, input_data);
			toggle_class(input, "svelte-1un7cml", true);
			add_location(input, file$1, 34, 2, 568);
			attr_dev(label, "class", "svelte-1un7cml");
			add_location(label, file$1, 31, 0, 518);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(select, file$2, 31, 2, 477);
			attr_dev(label, "class", "svelte-9b6wgl");
			add_location(label, file$2, 30, 0, 467);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function create_each_block_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(option, file$3, 35, 8, 1050);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(35:6) {#each states as state}",
		ctx
	});
...
// (32:4) <Select {store} name="ship_state">
function create_default_slot_2(ctx) {
	...
	const block = {
		c: function create() {
			...
			option.value = option.__value;
			add_location(option, file$3, 32, 6, 988);
		},
		m: function mount(target, anchor) {
			insert_dev(target, option, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(32:4) <Select {store} name=\\\"ship_state\\\">",
		ctx
	});
...
function create_each_block(ctx) {
	...
	const block = {
		c: function create() {
			...
			option.__value = option_value_value = /*state*/ ctx[1];
			option.value = option.__value;
			add_location(option, file$3, 49, 8, 1551);
		},
		m: function mount(target, anchor) {
			insert_dev(target, option, anchor);
			append_dev(option, t);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(49:6) {#each states as state}",
		ctx
	});
...
// (46:4) <Select {store} name="bill_state">
function create_default_slot_1(ctx) {
	...
	const block = {
		c: function create() {
			...
			option.__value = "State";
			option.value = option.__value;
			add_location(option, file$3, 46, 6, 1489);
		},
		m: function mount(target, anchor) {
			insert_dev(target, option, anchor);
			insert_dev(target, t1, anchor);
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(46:4) <Select {store} name=\\\"bill_state\\\">",
		ctx
	});
...
function create_default_slot(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(h20, "class", "svelte-113kjaz");
			add_location(h20, file$3, 19, 4, 372);
			attr_dev(h21, "class", "svelte-113kjaz");
			add_location(h21, file$3, 26, 4, 695);
			attr_dev(h22, "class", "svelte-113kjaz");
			add_location(h22, file$3, 40, 4, 1195);
			attr_dev(h23, "class", "svelte-113kjaz");
			add_location(h23, file$3, 54, 4, 1696);
		},
		m: function mount(target, anchor) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "slot",
		source: "(19:1) <Form {name} let:store>",
		ctx
	});
...
function create_fragment$3(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(main, "class", "svelte-113kjaz");
			add_location(main, file$3, 17, 0, 336);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
